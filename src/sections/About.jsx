...
import aegisVideo from "../assets/videos/theme2.mp4";
...
export default function About() {
  ...
  const leftDotX = useTransform(scrollYProgress, [0, 1], [0, -520]);
  const rightDotX = useTransform(scrollYProgress, [0, 1], [0, 480]);
    ...
    >
      ...
      <div className="relative mb-20">
        <div className="grid md:grid-cols-12 gap-10 items-center">
          ...
          <div className="md:col-span-7">
            <div className="h-[240px] sm:h-[380px] lg:h-[430px] rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_70px_rgba(36,190,176,0.45)]">
              <iframe
      ...
      <div className="relative mb-5">
        <div className="grid md:grid-cols-12 gap-10 items-center">
          {/* TEXT */}
          <div className="md:col-span-5 text-center md:text-center">
            <h2 className="text-[1.8rem] sm:text-[2rem] lg:text-[2.3rem] leading-[1] font-black uppercase font-[Archivo_Black] mb-6">
              E-Summit'25 :
              <span className="text-teal-300"> Aegis of Ascendence</span>
            </h2>

            <p className="text-sm sm:text-base text-white/90 leading-relaxed p-2 rounded-xl text-justify md:ml-auto">
          ...
          {/* VIDEO */}
          <div className="md:col-span-7">
            <div className="relative rounded-[28px] p-[1.5px] bg-gradient-to-br from-[#24BEB0]/60 via-[#1a3b3a]/40 to-[#0b1416]/80 shadow-[0_0_80px_rgba(36,190,176,0.45)]">
              <div className="relative h-[200px] sm:h-[320px] lg:h-[390px] rounded-[26px] overflow-hidden bg-black/60 backdrop-blur-xl border border-white/10 transition-all duration-500 hover:shadow-[0_0_120px_rgba(36,190,176,0.6)]">
                <video
                  src={aegisVideo}
                  autoPlay
                  muted
                  loop
                  playsInline
                  className="w-full h-full object-contain scale-[1.13]"
                />
