import{r as c,u as d,a as i,j as e,m as s}from"./index-CQ5UWJiD.js";const h="/esummit/assets/upstartCampus-Bbo4bsdG.png",g="/esummit/assets/DECRYPT-BBEhCIi6.png",u="/esummit/assets/SellYourSoul-DmpnYuZh.png",x="/esummit/assets/modelUnited-B_WSWuXu.png",f="/esummit/assets/beAnAngel-WARUgZlV.png",b="/esummit/assets/bg1-CT_tIByl.jpg",v="/esummit/assets/bg4-B9Vl0Chp.jpg",w="/esummit/assets/bg5-D1JPQh0D.jpg",j="/esummit/assets/bg6-DuNDudaK.jpg",y="/esummit/assets/bg7-nNZJOFAa.jpg",N=[{title:"DECRYPT",desc:"Ignite your entrepreneurial spirit with Decrypt, the ultimate case study competition. Dive into real-world challenges, make tough decisions, and embark on an exhilarating journey of problem-solving!",image:g,link:"https://unstop.com/competitions/decrypt-iit-kanpur-1609760",bg:b},{title:"BE AN ANGEL",desc:"Experience the investor's perspective in Be an Angel : Shark Tank Edition. Role-play as an Angel Investor with $5 million to invest. Assess startups, pitch investment strategies, and face VC judges. Understand both sides of the table in this nerve-wracking pitch competition.",image:f,link:"https://unstop.com/competitions/be-an-angel-iit-kanpur-1609387",bg:v},{title:"SELL YOUR SOLE",desc:"Prepare to unleash your marketing genius in the Sell Your Sole competition! Step into the shoes of a CMO and craft a game-changing marketing campaign for an existing brand. It's your chance to redefine success!",image:u,link:"https://unstop.com/competitions/sell-your-sole-iit-kanpur-1609421",bg:w},{title:"UPSTART CAMPUS",desc:"The classic pitching competition that showcases one's ability to ideate and pitch in front of judges from the across entrepreneurship world. Get the experience of being in the shoes of real life entrepreneur and learn what 'The Art of the Pitch' is all about.",image:h,link:"https://unstop.com/competitions/upstart-campus-iit-kanpur-1609728",bg:j},{title:"MODEL UNITED CORPORATION",desc:"Unlock the thrill of corporate leadership! Join Model United Corporations and immerse yourself in the world of CEOs, CMOs, and CFOs. Conquer high-pressure decision-making, strategic challenges, and teamwork. Sharpen your skills, seize the spotlight, and prove you've got what it takes to lead in the boardroom. Join the competition, transform into a corporate titan!",image:x,link:"https://unstop.com/competitions/model-united-corporation-iit-kanpur-1609475",bg:y}];function C(){const t=c.useRef(null),{scrollYProgress:n}=d({target:t,offset:["start end","center center"]}),l=i(n,[0,1],[0,-380]),o=i(n,[0,1],[0,380]);return e.jsxs("section",{id:"competitions",className:"relative  text-white overflow-x-hidden",children:[e.jsx("div",{className:`\r
         ...
         via-[#020406]/60\r
          to-transparent\r
        `}),e.jsx("div",{className:" absolute inset-0 -z-30 bg-[radial-gradient(120%_120%_at_50%_0%,#0e2b2a_0%,#05090c_45%,#020406_100%)]"}),e.jsx("div",{ref:t,className:"relative mb-16 overflow-hidden",children:e.jsxs("div",{className:"flex items-center justify-center gap-4",children:[e.jsxs("div",{className:"hidden md:flex items-center",children:[e.jsx(s.div,{className:"h-[2px] bg-gradient-to-l from-[#6fe9dc] to-transparent",initial:{width:0},whileInView:{width:"40vw"},transition:{duration:1.1,ease:"easeOut"},viewport:{once:!0}}),e.jsx(s.div,{style:{x:l},className:"w-2.5 h-2.5 rounded-full bg-[#6fe9dc]",animate:{boxShadow:["0 0 6px rgba(111,233,220,0.5)","0 0 14px rgba(111,233,220,0.9)","0 0 6px rgba(111,233,220,0.5)"]},transition:{duration:1.6,repeat:1/0}})]}),e.jsx("h2",{className:`\r
              text-center\r
            ...
            `,children:"COMPETITIONS"}),e.jsxs("div",{className:"hidden md:flex items-center",children:[e.jsx(s.div,{style:{x:o},className:"w-2.5 h-2.5 rounded-full bg-[#6fe9dc]",animate:{boxShadow:["0 0 6px rgba(111,233,220,0.5)","0 0 14px rgba(111,233,220,0.9)","0 0 6px rgba(111,233,220,0.5)"]},transition:{duration:1.6,repeat:1/0}}),e.jsx(s.div,{className:"h-[2px] bg-gradient-to-r from-[#6fe9dc] to-transparent",initial:{width:0},whileInView:{width:"40vw"},transition:{duration:1,ease:"easeOut",delay:.05},viewport:{once:!0}})]})]})}),N.map((r,a)=>e.jsx(k,{comp:r,mirrored:a%2!==0,index:a},a))]})}function k({comp:t,mirrored:n,index:l}){const o=c.useRef(null),{scrollYProgress:r}=d({target:o,offset:["start end","end start"]}),a=i(r,[0,1],n?["10%","0%"]:["-10%","0%"]),m=i(r,[0,1],[1,1.12]),p=i(r,[0,1],n?["-20%","20%"]:["20%","-20%"]);return i(r,[0,.5,1],[0,.25,0]),e.jsxs("section",{ref:o,className:`\r
        relative\r
        min-h-[65vh] md:min-h-[60vh]\r
        flex items-center\r
        overflow-hidden\r
      `,children:[e.jsx(s.div,{style:{x:p},className:`\r
    absolute inset-0\r
    z-0\r
    pointer-events-none\r
    overflow-hidden\r
  `,children:e.jsx("div",{className:`
    ...
    ${n?"right-[-20%]":"left-[-20%]"}
    bg-gradient-to-r
    ${l%2===0?"from-transparent via-[#0F4F48]/45 to-transparent":"from-transparent via-[#6FF2E3]/55 to-transparent"}
  `})}),e.jsxs("div",{className:`
        ...
        `,children:[e.jsx("div",{className:`\r
            ...
            py-12 md:py-0\r
          `,children:e.jsxs(s.div,{style:{scale:m},className:`\r
              relative\r
              mt-0\r
            ...
            `,children:[e.jsx("img",{src:t.bg,className:"absolute inset-0 w-full h-full object-cover opacity-75 ",alt:"",loading:"lazy",decoding:"async"}),e.jsx("img",{src:t.image,alt:t.title,className:`\r
                ...
                w-full h-full\r
                object-contain\r
                p-12 sm:p-14 md:p-15\r
              `,loading:"lazy",decoding:"async"})]})}),e.jsx("div",{className:`\r
            w-full md:w-1/2\r
            flex items-center\r
            px-6 sm:px-10 md:px-16 lg:px-24\r
            pb-16 md:pb-0\r
          `,children:e.jsxs(s.div,{style:{x:a},className:"max-w-md mx-auto md:mx-0 text-center md:text-left",children:[e.jsx("h3",{className:`\r
