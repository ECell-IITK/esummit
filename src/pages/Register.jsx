  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-6">
        <span className="text-3xl font-bold text-teal-300">{price}</span>
      </div>
        ...
        {ALL_FEATURES.map((feature, idx) => {
          ...
          return (
            <li key={idx} className="flex items-start gap-3">
              ...
              <span className={enabled ? "" : "text-white/40"}>{feature}</span>
            </li>
          );
        })}
      </ul>
      ...
      {/* CTA */}
      <a href="https://docs.google.com/forms/d/e/1FAIpQLSfBwn2SVIppxG8QXNy5bS0MIT_0cO0quCe5sXYyXPeghGO9dg/viewform" target="_blank">
      <button
        className="
          mt-auto
          w-full
