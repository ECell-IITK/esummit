import{j as e,m as s,r as d,u as p,a as i}from"./index-lnG0O-Hn.js";const h="/esummit-25/assets/upstartCampus-Bbo4bsdG.png",g="/esummit-25/assets/DECRYPT-BBEhCIi6.png",u="/esummit-25/assets/SellYourSoul-DmpnYuZh.png",x="/esummit-25/assets/modelUnited-B_WSWuXu.png",f="/esummit-25/assets/beAnAngel-WARUgZlV.png",b="/esummit-25/assets/bg1-CT_tIByl.jpg",v="/esummit-25/assets/bg4-B9Vl0Chp.jpg",w="/esummit-25/assets/bg5-D1JPQh0D.jpg",j="/esummit-25/assets/bg6-DuNDudaK.jpg",y="/esummit-25/assets/bg7-nNZJOFAa.jpg",N=[{title:"DECRYPT",desc:"Ignite your entrepreneurial spirit with Decrypt, the ultimate case study competition. Dive into real-world challenges, make tough decisions, and embark on an exhilarating journey of problem-solving!",image:g,link:"https://unstop.com/competitions/decrypt-iit-kanpur-1609760",bg:b},{title:"BE AN ANGEL",desc:"Experience the investor's perspective in Be an Angel:Shark Tank Edition. Role-play as an Angel Investor with $5 million to invest. Assess startups, pitch investment strategies, and face VC judges. Understand both sides of the table in this nerve-wracking pitch competition.",image:f,link:"https://unstop.com/competitions/be-an-angel-iit-kanpur-1609387",bg:v},{title:"SELL YOUR SOLE",desc:"Prepare to unleash your marketing genius in the Sell Your Sole competition! Step into the shoes of a CMO and craft a game-changing marketing campaign for an existing brand. It's your chance to redefine success!",image:u,link:"https://unstop.com/competitions/sell-your-sole-iit-kanpur-1609421",bg:w},{title:"UPSTART CAMPUS",desc:"The classic pitching competition that showcases one's ability to ideate and pitch in front of judges from the across entrepreneurship world. Get the experience of being in the shoes of real life entrepreneur and learn what 'The Art of the Pitch' is all about.",image:h,link:"https://unstop.com/competitions/upstart-campus-iit-kanpur-1609728",bg:j},{title:"MODEL UNITED CORPORATION",desc:"Unlock the thrill of corporate leadership! Join Model United Corporations and immerse yourself in the world of CEOs, CMOs, and CFOs. Conquer high-pressure decision-making, strategic challenges, and teamwork. Sharpen your skills, seize the spotlight, and prove you've got what it takes to lead in the boardroom. Join the competition, transform into a corporate titan!",image:x,link:"https://unstop.com/competitions/model-united-corporation-iit-kanpur-1609475",bg:y}];function C(){return e.jsxs("section",{id:"competitions",className:"relative  text-white overflow-x-hidden",children:[e.jsx("div",{className:`\r
  ...
  `}),e.jsx("div",{className:"relative py-16 md:py-10 overflow-hidden",children:e.jsxs("div",{className:"flex items-center justify-center gap-4",children:[e.jsxs("div",{className:"flex items-center",children:[e.jsx(s.div,{className:"h-[2px] bg-gradient-to-l from-[#6fe9dc] to-transparent",initial:{width:0},whileInView:{width:"34vw"},transition:{duration:1.1,ease:"easeOut"},viewport:{once:!0}}),e.jsx(s.div,{className:"w-2.5 h-2.5 rounded-full bg-[#6fe9dc]",animate:{boxShadow:["0 0 6px rgba(111,233,220,0.5)","0 0 14px rgba(111,233,220,0.9)","0 0 6px rgba(111,233,220,0.5)"]},transition:{duration:1.6,repeat:1/0}})]}),e.jsx("h2",{className:`\r
      ...
      `,children:"COMPETITIONS"}),e.jsxs("div",{className:"flex items-center",children:[e.jsx(s.div,{className:"w-2.5 h-2.5 rounded-full bg-[#6fe9dc]",animate:{boxShadow:["0 0 6px rgba(111,233,220,0.5)","0 0 14px rgba(111,233,220,0.9)","0 0 6px rgba(111,233,220,0.5)"]},transition:{duration:1.6,repeat:1/0}}),e.jsx(s.div,{className:"h-[2px] bg-gradient-to-r from-[#6fe9dc] to-transparent",initial:{width:0},whileInView:{width:"34vw"},transition:{duration:1,ease:"easeOut",delay:.05},viewport:{once:!0}})]})]})}),N.map((t,n)=>e.jsx(k,{comp:t,mirrored:n%2!==0,index:n},n))]})}function k({comp:t,mirrored:n,index:o}){const a=d.useRef(null),{scrollYProgress:r}=p({target:a,offset:["start end","end start"]}),l=i(r,[0,1],n?["10%","0%"]:["-10%","0%"]),c=i(r,[0,1],[1,1.12]),m=i(r,[0,1],n?["-20%","20%"]:["20%","-20%"]);return i(r,[0,.5,1],[0,.25,0]),e.jsxs("section",{ref:a,className:`\r
        relative\r
        min-h-[65vh] md:min-h-[70vh]\r
        flex items-center\r
        overflow-hidden\r
      `,children:[e.jsx(s.div,{style:{x:m},className:`\r
    absolute inset-0\r
    z-0\r
    pointer-events-none\r
    overflow-hidden\r
